...
![Seaborn](https://img.shields.io/badge/Seaborn-77AADD?style=flat-square&logo=python&logoColor=white)
...
- **Causal AI Benchmark Pipeline** - reproducible evaluation of causal-inference algorithms · `Python · scikit-learn` · <!-- link -->
- **Data Analysis & BI Dashboard** - EDA to interactive stakeholder dashboard · `Pandas · Power BI / Tableau` · <!-- link -->

</details>

---

<p align="center"><i>Currently open to work & research opportunities - let's build something useful.</i></p>
